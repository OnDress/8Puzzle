...
def uniform_cost_search(problem):
    ...
    while True:
        ...
        for action in problem.get_actions(node.state):
            ...
            if not search_helper.e_state_exists(explored,child.state) and not q.exists(child.state):
                q.insert(child)
...
def misplaced_tile_search(problem):
    ...
    while not q.is_empty():
        ...
        for action in problem.get_actions(node.state):
            ...
            elif search_helper.e_state_exists(explored, child.state):
                i = search_helper.e_exists_element(explored,child.state)
